    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div style={{ width: "100%", maxWidth: 400, display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        <div style={{ textAlign: "center", display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <p style={{ fontFamily: "var(--font-abel)", fontSize: 14, color: "#9C9B99", margin: 0 }}>Create your account</p>
        </div>
        ...
        <p style={{ textAlign: "center", fontFamily: "var(--font-abel)", fontSize: 13, color: "#9C9B99", margin: 0 }}>
          ...
          <Link href="/login" style={{ color: "#1A1918", fontWeight: 600, textDecoration: "none" }}>
            Sign in
          </Link>
        </p>
      </div>
